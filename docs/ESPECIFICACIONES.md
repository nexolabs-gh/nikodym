...
- **Parámetros numéricos**: extraídos y verificados contra texto oficial CMF/SBIF en [`docs/normativa_cmf_parametros.md`](normativa_cmf_parametros.md) (comercial individual A1–C6, grupal, consumo 2025, vivienda PVG, contingentes B-3, garantías). **Requieren validación humana contra el CNC v2022 vigente antes de uso productivo**; **2 pendientes documentados** —los que declara `pending_items` del manifiesto, ambos marcados `FALTA-DATO`—: los haircuts/factores de descuento de garantías financieras del B-1 letra c, que la norma remite a circular específica de la CMF, y las tablas numéricas del RAN 21-10. (El mapeo BBB-/Baa3 quedó resuelto por verificación visual 2026-06-23.) Las matrices se tratan como **datos versionados**, no constantes hardcodeadas.
