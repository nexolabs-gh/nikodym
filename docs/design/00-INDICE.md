...
> exige una columna de grado que un scorecard no trae (override en el catálogo, D-EJE). Trece
> revisiones adversariales del rango el mismo día; dieciséis hallazgos sobre esta enmienda, todos
