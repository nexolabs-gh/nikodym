...
> exige una columna de grado que un scorecard no trae (override en el catálogo, D-EJE). Doce
> revisiones adversariales del rango el mismo día; quince hallazgos sobre esta enmienda, todos
...
> DAG y no aviso, y el panel de validación muestra los grados no evaluables que las tablas tidy
> omiten. Cinco capas con gates y controles negativos; el
