...
> exige una columna de grado que un scorecard no trae (override en el catálogo, D-EJE). Tres
> revisiones adversariales el mismo día (siete hallazgos, todos sostenidos y corregidos: gate del
...
> evaluabilidad). Cinco capas con gates y controles negativos; el `config_hash` de F1/F5 se mueve
> sólo en la capa de release, junto con la recaptura única. Once decisiones para Cami en §8.
