    ...
    min_rows_per_group: int = Field(
        ...
        json_schema_extra={
            "ui_help": (
                ...
                "recibe el test por grado. Protege también cada grupo de PD dentro de la prueba "
                "de Hosmer-Lemeshow: si el grupo más chico queda bajo el mínimo, esa muestra "
                "queda sin veredicto. Todo lo que no se evalúa sale marcado con su causa en vez "
                "de dar un número engañoso. Con diez grupos y el mínimo de fábrica, una muestra "
                "necesita al menos 300 operaciones."
            ),
            "ui_widget": "number_input",
