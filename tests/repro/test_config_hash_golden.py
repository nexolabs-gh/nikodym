...
# B20.1: se añadió la clave computacional `forward=None`, por eso el golden cambió.
...
# B14.1: se añadió la clave computacional `explain=None` (explicabilidad, SDD-14); el golden cambió.
