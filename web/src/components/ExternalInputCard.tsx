...
export function ExternalInputCard({
  ...
  const llaveDesalineada =
    input !== undefined && carteraKeyMismatch(input.keyColumn, carteraColumns)
      ...
      <CardContent className="space-y-4">
        ...
        {input !== undefined ? (
          <div className="space-y-4">
            ...
            {llaveDesalineada ? (
              /* D-PUE-6-bis: emparejar exige la columna en los DOS archivos. El backend lo rechaza
                 al ejecutar; aquí se dice antes y con las dos salidas, porque quien está probando
                 algo rápido tiene que poder seguir. */
              <p
              ...
              >
                ...
                <span>
                  Tu cartera no tiene la columna «{input.keyColumn}», así que no se pueden emparejar
                  las filas por ella. Elige una columna que esté en los dos archivos, o vuelve a la
                  opción de emparejar por orden de filas.
                </span>
              </p>
            ) : null}
